      ...
      <section className={styles['home-page']}>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.buttons}>
            <Link href="/association"><button className={styles.full}>Découvrir l'association</button></Link>
            <Link href="/vehicule"><button className={styles.empty}>Nos Véhicules</button></Link>
          </div>
        </div>
      </section>
</>
